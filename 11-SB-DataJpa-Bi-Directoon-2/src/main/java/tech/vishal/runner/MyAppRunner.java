...
public class MyAppRunner implements ApplicationRunner{
	...
	List<Orders> printOrders = ordersService.printorders();
		printOrders.stream().forEach(s-> System.out.println(s.getOrderId()+" "+s.getDatePurchased()+" "+s.getStatus()));
		printOrders.stream().forEach(s ->   System.out.println(s.getCustomer().getId()+" "+s.getCustomer().getName()+""+s.getDatePurchased()+""+s.getStatus()));
